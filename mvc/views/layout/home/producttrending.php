        ...
        <div class="col">
            <div class="product-img">
                ...
                <div class="hover-button" id="item<?php echo $data["product"][$i]["id"];?>">
                    ...
                    <a class="bt-add flex bt addCart" data-id="<?php echo $data["product"][$i]["id"]?>" href="<?php echo URL . 'cart/store/' . $data["product"][$i]["id"]; ?>">
                        <span data-id="<?php echo $data["product"][$i]["id"]?>" class="flex">Quick Shop</span>
                        <span   id="input<?php echo $data["product"][$i]["id"]?>" class="bt-icon flex"> <i class="fas fa-shopping-cart"></i></span>
                        <input id="laysoluong" type="hidden" value="<?php echo $data["product"][$i]["soluong"]?>">
                    </a>
                </div>
