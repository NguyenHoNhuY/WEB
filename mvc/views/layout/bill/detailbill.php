...
<body>
    ...
    <section class="detail-bill" style="margin-top:10%">
                ...
                <div class="col-lg-8 col-sm-12">
                    ...
                    ?>
                        <table border="1" cellpadding="0">
                            ...
                            ?>
                                <tr>
                                    <td class="num"><?php echo $value['sohoadon'] ?></td>
                                    <td class="num"><?php echo $value['id_sanpham'] ?></td>
                                    ...
                                    <td class="num"><?php echo $value['giasanpham'] ?></td>
                                    <td class="num"><?php echo $value['soluongdat'] ?></td>
