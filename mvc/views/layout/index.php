        ...
        <div class="recommend-slider">
            <div class="container full">
                <div id="01" class="slide-item full">
                    <div class="img full">
                        <img src="<?php echo URL_LAYOUT ?>img/product/women/women.jpg" alt="" />
                    </div>
                    <div class="content">
                        <p>
                            The Women <br />
                ...
                <div id="02" class="slide-item full hide">
                    <div class="img full">
                        <img src="<?php echo URL_LAYOUT ?>img/product/men/man.jpg" alt="" />
                    </div>
                    <div class="content">
                        <p>
                            The Man <br />
            ...
            <div class="pop-up-content">
                ...
                <div class="modal-img flex">
                    <div class="img-content ">
                        <a href="#"><img class="modal-img1" src="<?php echo URL_LAYOUT . 'img/product/' . $data["product"][$i]["image1"]; ?>" alt=""></a>
                        <a href="#"><img src="<?php echo URL_LAYOUT . 'img/product/' . $data["product"][$i]["image2"]; ?>" alt=""></a>
                    </div>
                </div>
                <div class="modal-content">
                    <div class="product-detail-right">
                        <h2 class="product-title">Champion Life, Photo Real C Logo Heritage T-Shirt - Black</h2>
                        ...
                        <div class="product-detail1">
                            <div class="addtoCart flex">
                                <button id="open">
                                    <img src="http://localhost/PHP/DOAN-CARONO/public/layout/img/product/cart.png">
                                    <span>ADD TO CART</span>
                                    <a href="<?php echo URL . 'layout/detail/' . $data["product"][$i]["id"] ?>"></a>
                                </button>
                            </div>
                            <div class="addtoCart-mobile">
                                <div class="product_quantity_mobile">
                                    <div class="container">
                                        <i class="fa fa-minus prev_mobile" aria-hidden="true" onclick="prevNum_mobile()"></i>
                                        <i class="fa fa-plus next_mobile" aria-hidden="true" onclick="nextNum_mobile()"></i>
                                    </div>
                                </div>
                                <br>
                                <button type="button">
