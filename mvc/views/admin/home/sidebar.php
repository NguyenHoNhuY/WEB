<aside style="background-color: #000;" class="main-sidebar  elevation-4">
    <div class="sidebar">
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="" class="d-block" style="color: orange;"> <?php
        ...
        <li class="nav-item has-treeview menu-open">
            ...
            <i class="fa fa-pie-chart" aria-hidden="true"></i>
              <p style="    margin-left: 5px;">
                Statictis
                <i style="padding-left: 162%;" class="fa fa-angle-right" aria-hidden="true"></i>
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                ...
                <a href="<?php echo URL.'bill/allbill';?>" class="nav-link ">
                  <i class="fa fa-spinner nav-icon"></i>
                  <p>All bill</p>
                </a>
              </li>
         ...
         <li class="nav-item has-treeview signout">
