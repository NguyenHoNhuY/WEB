$(document).ready(function () {
  ...
  $(".bt-view").click(function (e) {
    ...
    $(".modal-img1").attr(
      "src",
      "<?php echo URL_LAYOUT . 'img/product/' . $data[" +
        "product" +
        "][" +
        id +
        "][" +
    ...
    $(".pop-up-content ").addClass("pop-up-content-active");
    $("html").css({
      overflow: "hidden",
    });
  });
  $(".modal-btn-close,.overlay").click(function (e) {
    $(".overlay").removeClass("db");
    $(".overlay").removeClass("overlay-active");
    $(".pop-up-content ").removeClass("pop-up-content-active");
    $("html").css({
      overflow: "",
    });
  });
